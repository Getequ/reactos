...
@ stdcall -stub -version=0x600+ RegCloseKey(long)
@ stdcall -stub -version=0x600+ RegCreateKeyA(long str ptr)
@ stdcall -stub -version=0x600+ RegCreateKeyExA(long str long ptr long long ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegCreateKeyExW(long wstr long ptr long long ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegCreateKeyW(long wstr ptr)
@ stdcall -stub -version=0x600+ RegDeleteKeyA(long str)
@ stdcall -stub -version=0x600+ RegDeleteKeyExA(long str long long)
@ stdcall -stub -version=0x600+ RegDeleteKeyExW(long wstr long long)
@ stdcall -stub -version=0x600+ RegDeleteKeyW(long wstr)
@ stdcall -stub -version=0x600+ RegDeleteValueA(long str)
@ stdcall -stub -version=0x600+ RegDeleteValueW(long wstr)
@ stdcall -stub -version=0x600+ RegEnumKeyA(long long ptr long)
@ stdcall -stub -version=0x600+ RegEnumKeyExA(long long ptr ptr ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegEnumKeyExW(long long ptr ptr ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegEnumKeyW(long long ptr long)
@ stdcall -stub -version=0x600+ RegEnumValueA(long long ptr ptr ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegEnumValueW(long long ptr ptr ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegGetValueA(long str str long ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegGetValueW(long wstr wstr long ptr ptr ptr)
...
@ stdcall -stub -version=0x600+ RegLoadMUIStringA(ptr str str long ptr long str)
@ stdcall -stub -version=0x600+ RegLoadMUIStringW(ptr wstr wstr long ptr long wstr)
@ stdcall -stub -version=0x600+ RegOpenCurrentUser(ptr ptr)
@ stdcall -stub -version=0x600+ RegOpenKeyA(long str ptr)
@ stdcall -stub -version=0x600+ RegOpenKeyExA(long str long long ptr)
@ stdcall -stub -version=0x600+ RegOpenKeyExW(long wstr long long ptr)
@ stdcall -stub -version=0x600+ RegOpenKeyW(long wstr ptr)
@ stdcall -stub -version=0x600+ RegQueryInfoKeyA(long ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegQueryInfoKeyW(long ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegQueryValueA(long str ptr ptr)
@ stdcall -stub -version=0x600+ RegQueryValueExA(long str ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegQueryValueExW(long wstr ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ RegQueryValueW(long wstr ptr ptr)
@ stdcall -stub -version=0x600+ RegSetValueA(long str long ptr long)
@ stdcall -stub -version=0x600+ RegSetValueExA(long str long long ptr long)
@ stdcall -stub -version=0x600+ RegSetValueExW(long wstr long long ptr long)
@ stdcall -stub -version=0x600+ RegSetValueW(long wstr long ptr long)
